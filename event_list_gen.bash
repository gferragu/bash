...
dir=best_records/kamchatka_azi/for_record_section/RTZ

cd $dir

echo Station / Event Time#.#Az Dist#.#Back Azimuth#.#Depth#.#ArrT#.#Ray Parameter#.#Lon#.#Lat#.#Virtual Source Distance# | awk -F. '{print $1,$2,$3,$4,$5,$6,$7,$8,$9}' > evntInfo.txt
